...
class InstrumentEdit extends React.Component {
  ...
  render() {
    console.log(this.state.ManuData.PName)
        ...
        <form className="ins-edit-form">
          ...
          <div className="ins-edit-content">
            ...
            <label htmlFor="name" className="ins-edit-label font-size-1rem">
              名稱
              <input id="name" type="text" className="font-size-114rem" defaultValue={this.state.ManuData.PName}/>
            </label>
            ...
            <label htmlFor="amount" className="ins-edit-label font-size-1rem">
              數量
              <input id="amount" type="text" className="font-size-114rem" />
            </label>
            <label htmlFor="price" className="ins-edit-label font-size-1rem">
              價格
              <input id="price" type="text" className="font-size-114rem" />
            </label>
            <label htmlFor="text1" className="ins-edit-label font-size-1rem">
              簡介
              <input id="text1" type="text" className="font-size-114rem" />
            </label>
            <label
              htmlFor="text2"
              className="ins-edit-content-text font-size-1rem"
            >
              介紹<textarea id="text2" className="font-size-114rem"></textarea>
            </label>
            <button type="submit" className="ins-edit-add-btn">
              確認
            </button>
          </div>
        </form>
