  ...
  return (
    <>
      <div id="product-id-desciption-wrapper">
        ...
        <p className="product-id-desciption-text-p">
          鼓殼是鼓的自然響音 受"干擾"或"共鳴"的關鍵因素。因此，Stage
          Custom使用100%樺木 - 是高級鼓組中的經典。此外，Stage Custom 的
          6層結構可精準地傳導打擊表面時所產生的震動，讓表演超越同等級其他產品。
          大型的超硬樹脂球外覆美麗的鍍鉻外殼，以鈦金屬材質的人體工學蝶形螺椎
          (wing bolt) 固定。這是
          非常體貼鼓手的裝置，不管在鼓手能想到的任何位置都不會滑動。此外，球形螺栓讓調音者只要輕鬆
          轉動鼓的方向，就能進行底鼓面 (bottom head) 的調音。 新的Stage
