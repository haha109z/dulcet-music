...
class VideoPutOn extends React.Component{
    ...
    return(
        ...
        <form className="video-puton-form">
            ...
            <button type="submit" className="video-new-add">新增影片</button>
            ...
            <label className="video-puton-label font-size-1rem">影片類型
            <select className="video-value font-size-114rem" onChange={this.handlechange}>
            <option value=""></option>
            ...
            <button type="submit" className="video-add-btn">確認</button>
            </div>
