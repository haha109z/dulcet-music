            ...
            <>
                <form onSubmit={this.handleSubmit} >
                    <div className="form-group">
                        ...
                        <input type="email" name="username" className="form-control col-md-12" id="userEmail" placeholder="請輸入電子郵件" value={this.state.username} onChange={this.onChange} />
                    </div>
                    <div className="form-group">
                        <label htmlfor="password" className="col-md-12 control-label">密碼</label>
                        <input type="password" name="userPassword" className="form-control" id="userPassword" placeholder="請輸入密碼" value={this.state.password} onChange={this.onChange} />
                    </div>
