                ...
                <div className="user-register-body row">
                    <form onSubmit={this.handleSubmit} className="col-md-6 register-form-wrap">
                        <div className="form-group">
                            ...
                            <input type="text" className="form-control col-md-12" id="userRegisterName" placeholder="請輸入姓名" />
                        </div>
                        <div className="form-group">
                            <label htmlfor="userRegisterEmail" className="col-md-12 control-label">電子郵件</label>
                            <input type="email" className="form-control col-md-12" id="userRegisterEmail" placeholder="請輸入電子郵件" />
                        </div>
                        <div className="form-group">
                            <label htmlfor="userRegisterBir" className="col-md-12 control-label">生日</label>
                            <input type="text" className="form-control col-md-12" id="userRegisterBir" placeholder="請輸入出生年月日" />
                        </div>
                        <div className="form-group">
                            <label htmlfor="userRegisterAddress" className="col-md-12 control-label">地址</label>
                            <input type="text" className="form-control col-md-12" id="userRegisterAddress" placeholder="請輸入地址" />
                        </div>
                        <div className="form-group">
                            <label htmlfor="userRegisterMobile" className="col-md-12 control-label">手機號碼</label>
                            <input type="text" className="form-control col-md-12" id="userRegisterMobile" placeholder="請輸入手機號碼" />
                        </div>
                        <div className="form-group">
                            <label htmlfor="userRegisterPassword" className="col-md-12 control-label">密碼</label>
                            <input type="password" className="form-control" id="userRegisterPassword" placeholder="請輸入密碼" />
                        </div>
                        <div className="form-group">
